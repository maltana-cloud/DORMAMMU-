...
from ..modules.creative import CreativeBrief, CreativePipeline, CreativeProvider, CreativeProviderRegistry, CreativeResult, CreativeLineageStore
...
class DORMAMMURuntime:
    ...
    def __init__(self, *, lifecycle_store_path: str = ":memory:", operation_store_path: str = ":memory:", resource_lease_store_path: str = ":memory:", autonomy_store_path: str = ":memory:", creative_lineage_store_path: str = ":memory:", recovery_secret: bytes | None = None, canary_policy: CanaryPolicy | None = None) -> None:
        ...
        self.creative_providers = CreativeProviderRegistry(); self.creative = CreativePipeline(providers=self.creative_providers, lineage=CreativeLineageStore(path=creative_lineage_store_path))
