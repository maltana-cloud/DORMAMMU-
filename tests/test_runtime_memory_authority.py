...
def test_runtime_composes_persistent_memory_and_revocable_authority():
    ...
    with TemporaryDirectory() as directory:
        ...
        first.set_authority("owner", "public.publish", AuthorityMode.ALLOWED)
        ...
        second.set_authority("owner", "public.publish", AuthorityMode.DENIED, expected_version=1)
...
def test_runtime_authority_defaults_to_deny_and_supports_expiry():
    ...
    try:
        ...
        runtime.set_authority("owner", "email.create", AuthorityMode.ALLOWED, expires_at=now + timedelta(minutes=1))
